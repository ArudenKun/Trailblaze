...
namespace Trailblaze.Avalonia.Hosting.Internals;
...
internal sealed class AvaloniaThread
{
    ...
    private void ThreadStart()
    {
        try
        {
            ...
            {
                if (appBuilder.Instance is { } instance)
                {
                    instance.Resources[AvaloniaHostingExtensions.ServiceProviderResourceKey] =
                        _serviceProvider;
                }
            });
