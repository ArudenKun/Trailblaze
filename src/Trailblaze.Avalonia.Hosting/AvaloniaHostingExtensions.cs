...
using Trailblaze.Avalonia.Hosting.Internals;

namespace Trailblaze.Avalonia.Hosting;
...
{
    internal const string ServiceProviderResourceKey =
        $"ServiceProvider.{nameof(AvaloniaHostingExtensions)}.{nameof(AvaloniaHostedService)}";
    ...
    public static IServiceProvider GetServiceProvider(this Application? app) =>
        ...
        ?? throw new InvalidOperationException("Avalonia not yet initialized");
